...
ДляВсех (Наименований())
   {
    ...
    Если(обувь_взр_1_равно_2_658(пКодарт)!=0)
     {
...
ДляВсех(Наименований())
{
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и обувь_взр_1_равно_2_658(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
...
Функция _СортировкаМас_658(оМасТов)
{
