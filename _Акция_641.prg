...
ДляВсех (Наименований())
   {
    ...
    Если(браво_40_2плюс1_подарок_642(пКодарт)!=0)
     {
    ...
    Если(браво_40__2плюс1_641(пКодарт)!=0 и пСканПодарок==0)
     {
...
ДляВсех(Наименований())
{
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и браво_40_2плюс1_подарок_642(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и браво_40__2плюс1_641(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
   пЦена2=ЦенаНаДату('Дата',"Цена2");
   Если(пЦена2!=0) пЦена3=пЦена2
...
Функция _СортировкаМас_641(оМасТов)
{
