...
ДляВсех(Наименований())
   {
    ...
    Если(подарок_к_акции_790_792(пКодарт)!=0
    и пЦена2==0
    и Наим.СуммаЦен>0)
     {
    ...
    Если(при_покупке_2х_футболок_3я_в_подарок_790(пКодарт)!=0 
    и пСканПодарок==0
    и пЦена2==0
    и Наим.СуммаЦен>0)
     {
...
ДляВсех(Наименований())
{
   ...
   и Наим.СуммаЦен>0 
   и пЦена2==0
   и подарок_к_акции_790_792(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и при_покупке_2х_футболок_3я_в_подарок_790(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
   пЦена3=ЦенаНаДату('Дата',"Цена3");
...
Функция _СортировкаМас_790(оМасТов)
{
