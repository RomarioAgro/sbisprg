...
ДляВсех (Наименований())
   {
    ...
    Если(sisi_fascino__2_плюс_1_подарок_681(пКодарт)!=0)
     {
    ...
    Если(sisi_fascino__2_плюс_1_680(пКодарт)!=0 и пСканПодарок==0)
     {
...
ДляВсех(Наименований())
{
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и sisi_fascino__2_плюс_1_подарок_681(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и sisi_fascino__2_плюс_1_680(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
   пЦена2=ЦенаНаДату('Дата',"Цена2");
   Если(пЦена2!=0) пЦена3=пЦена2
...
Функция _СортировкаМас_680(оМасТов)
{
