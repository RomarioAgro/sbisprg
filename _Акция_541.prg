Функция _Акция_541()
{
  ...
  ДляВсех (Наименований())
  {
    ...
    пЦенаМеньше=0
    пФлагКат=1;
    Если(вяз_женское_541(пКодарт)!=0) пФлагПоиск1=1
      ...
      Если(Найти(пСтрокаакции,пКодарт2)!=0)
         {
            ...
            'Наим.Комментарий'="541";
            'Примечание'+="541;";
            Сохранить(Наим);
         }
      Иначе Если(вяз_женское_541(пКодарт)!=0) 'Наим.СуммаЦен'=Окр(пЦена3*Наим.Кол_во,1)
    }
  }
}


Функция _СортировкаМас_541(оМасТов)
{
