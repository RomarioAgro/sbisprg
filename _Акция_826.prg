...
пСтрокаКат=";65;143;137;121;116;"#строка правильных категорий
...
ДляВсех(Наименований()) 
{
   ...
   Иначе пФлагЦена=0;   
   Если(((_ТКК_826('НАИМ.Иерархия.НомНомер')==0 #проверяем, что наш товар не входит 
   #в списки исключения
   и купи_2_вещи_3_в_подарок_детское_826(пКодарт)==0
   и пФлагКат>0
   и пФлагЦена==1)
   и пЦена2!=0
...
ДляВсех(Товаров(1,пКодарт))
   {
      Если(('ТОВАР.Класс'=="2" 
      и 'ТОВАР.Группа'=="34"
      и 'ТОВАР.Категория'=="371")
      или 
      ('ТОВАР.Класс'=="2" 
      и 'ТОВАР.Группа'=="35"
      и 'ТОВАР.Категория'=="376")) Вернуть(1) 
      Иначе Вернуть(0);
   }
}

Функция _СортировкаМас_826(оМасТов)
{
