...
ДляВсех(Наименований())
   {
    ...
    Если(партнер_колготки_2_плюс_1__подарок_729(пКодарт)!=0)
     {
    ...
    Если(партнер_колготки_2_плюс_1_728(пКодарт)!=0 и пСканПодарок==0)
     {
...
ДляВсех(Наименований())
{
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и партнер_колготки_2_плюс_1__подарок_729(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и партнер_колготки_2_плюс_1_728(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
   пЦена2=ЦенаНаДату('Дата',"Цена2");
   Если(пЦена2!=0) пЦена3=пЦена2
...
Функция _СортировкаМас_728(оМасТов)
{
