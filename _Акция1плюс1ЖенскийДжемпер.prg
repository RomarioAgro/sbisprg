Функция _АкцияЖен2йДжемперминус50172()
{
#Акция - 2 женских джемпера из списка, 1 - 50%(самый дешевый)
...
{#формирование массива товаров участвующих в акции вообще
   ...
   Если(Наим.СуммаЦен>0 и жен_2й_джемпер_50_процентов_скидка_172(пКодарт)==1) 
   {
...
ДляВсех(Наименований())
{
   ...
   и Наим.СуммаЦен>0)
   {
   '.Примечание'="Акция 1плюс1 жен джемпер";
      Если(Найти(оМас[пНомерОбнуления],Наим.НомНомер)!=0)
        {
         ...
         'Наим.Комментарий'="Акция 1плюс1 жен джемпер";
         Сохранить(Наим);
         }
      Иначе
