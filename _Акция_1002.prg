...
пКодАрт="";
   ДляВсех(Наименований()) 
   {
      ...
      пВкл=_ТКК_1002(НАИМ.Иерархия.НомНомер)
      Если(пВкл==0) пВкл=1000_рублей_сертификат_1002(пКодарт)
      Если(пВкл==1) 
      {
         пВкл=Найти('Наим.Наименование',"1000GC")
         Если(пВкл==0) пВкл=Найти('Наим.Наименование',"1000BL")
      }
...
Если(пКолАкции>=50)
   ДляВсех(Наименований()) 
   {
      ...
      Если(пКолАкции>=50
       и пКолАкции<=99) 'Наим.СуммаЦен'=Окр(Наим.Кол_во*0.93*пЦена3,1);
      Если(пКолАкции>=100
       и пКолАкции<=149) 'Наим.СуммаЦен'=Окр(Наим.Кол_во*0.90*пЦена3,1);
      Если(пКолАкции>=150)'Наим.СуммаЦен'=Окр(Наим.Кол_во*0.85*пЦена3,1);
      'Наим.Комментарий'="1002";
      Сохранить(Наим);
      '.Примечание'+="1002;";
      }
   }
