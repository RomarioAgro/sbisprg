...
#Рубашки мужские,товар СВЫШЕ 296руб
...
пСтрокаКат=";62;107;118;116;63;"#строка правильных категорий
...
ДляВсех(Наименований()) 
{
   ...
   Иначе пФлагЦена=0;   
   Если(((_ТКК_795('НАИМ.Иерархия.НомНомер')==0 #проверяем, что наш товар не входит 
   #в списки исключения
   и купи_2_вещи_третья_в_подарок_мужское_795(пКодарт)==0
   и пФлагКат>0
   и пФлагЦена==1)
   и пЦена2==0
   или купи_2_вещи_третья_в_подарок_мужское_включение_803(пКодарт)!=0)
   и Наим.СуммаЦен>0) 
   {
#   пЦена2=ЦенаНаДату('Дата',"Цена2");
#   Если(пЦена2==0) 
...

Функция _СортировкаМас_795(оМасТов)
{
