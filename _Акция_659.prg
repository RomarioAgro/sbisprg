...
ДляВсех (Наименований())
   {
    ...
    Если(обувь_детская_вторая_зимняя_пара_минус_50_подарок_659(пКодарт)!=0)
     {
    ...
    Если(обувь_детская_вторая_зимняя_пара_минус_50_660(пКодарт) и пСканПодарок==0)
     {
...
{
_СортировкаМас_659(оМас)

пНомерСкидки=Окр(((пКолАкции+пКолПодарок)/пОснованиеАкции-0.1),1)#нам нужно округление вниз
...
ДляВсех(Наименований())
{
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и обувь_детская_вторая_зимняя_пара_минус_50_подарок_659(пКодарт)!=0)
   {
   Наим.СуммаЦен=0;
      ...
      Если(оМас[эНомер]=='Наим.НомНомер')
         {
            ...
            Иначе 
            {
               Наим.СуммаЦен+=Окр(ЦенаНаДату('Дата',"Цена3")*0.5,1);
               'Наим.Комментарий'="659";
               '.Примечание'+="659;";
               Сохранить(Наим);
            }
         }
   ...
   Если(Размер(оМас)>=0
   и Наим.СуммаЦен>0 
   и обувь_детская_вторая_зимняя_пара_минус_50_660(пКодарт)!=0
   и обувь_детская_вторая_зимняя_пара_минус_50_подарок_659(пКодарт)==0)
   {
   Наим.СуммаЦен=0;
   пЦена2=ЦенаНаДату('Дата',"Цена2");
...

Функция _СортировкаМас_659(оМасТов)
{
